...
const SummaryPage = () => {
	...
	return (
		<PageWrapper ref={ref} title='Welcome'>
			<SubHeader>
				<SubHeaderLeft>
					<span className='fw-bold'>Bienvenido</span>
					<SubheaderSeparator />
					<span>
						Inicio{' '}
						<sup>
				...
				<SubHeaderRight>
					...
					<Button
						...
						isLight
						tag='a'
						href='mailto:vasabogalse@unal.edu.co'
						...
						<div
							...
							<div>
								<h1 className='display-1 mb-4'>
									Bienvenido a la dApp de Electrochain.org<Logo2 height={70} />
								</h1>
								<p className='display-6 mb-4'>
									Todo lo que necesitas para gestionar tu energía tokenizada.
								</p>
								<p className='h2 mb-5'>
